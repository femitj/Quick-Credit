...
const migrateData = async () => {
  ...
  await db(loanDb.createLoan('seun@gmail.com', '2/1/2018', '5 months', 100000, 21000, 'approved', false, 0, 5000, 'seun', 'Tijani'));
  await db(loanDb.createLoan('bola@gmail.com', '2/1/2018', '5 months', 100000, 21000, 'approved', true, 0, 5000, 'bola', 'Tijani'));
  await db(loanDb.createLoan('bola@gmail.com', '2/1/2018', '5 months', 100000, 21000, 'approved', true, 0, 5000, 'bola', 'Tijani'));
